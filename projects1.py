...
#tipo do pet
tipo = input("Seu pet é um: cachorro, gato ou ave?")
...
#Cadastro Final
print("Ok para que seu pet seja atendido por um de nossos médicos")
print("precisamos do seu número de celular:")
...
if plano == "1":
    ...
    print("\n Plano Premium \n Benefícios: ")
    print("4 tosas disponíveis por mês \n Vacinas inclusas \n Desconto em medicamentos")
elif plano == "3":
    print("\n Plano VIP \n Benefícios: ")
...
if nota >= 9:
    ...
    print("Você disse que é bom")
    print("veremos o que podemos fazer para melhorarmos para atingirmos a excelência!")
elif nota >= 5:
